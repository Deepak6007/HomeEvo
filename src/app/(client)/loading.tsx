  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center space-y-4 font-body p-6 text-[#3D2B1F]">
      ...
      <div className="space-y-1 text-center">
        <h3 className="font-serif text-base font-bold text-[#3D2B1F]">Preparing Workspace</h3>
        <p className="text-2xs text-[#6F5B4B] font-medium tracking-wide uppercase">Connecting to secure ledger...</p>
      </div>
    </div>
  )
}
